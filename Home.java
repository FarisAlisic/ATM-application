...
public class Home {
	...
	public void homeView(String cardNum){
		...
		quick.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) { 
				Quick qk = new Quick();
				qk.quickView(cardNum);
				frame.dispose();
			}
		});
		withdraw.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				operations.opView("Withdraw Amount", cardNum);
				frame.dispose();
			}
		});
		deposit.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) { 
				operations.opView("Deposit Amount", cardNum);
				frame.dispose();
			}
		});
		...
		bal.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) { 
				operations.opView("Balance", cardNum);
				frame.dispose();
			}
		});
		pinchange.addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) { 
				operations.opView("New PIN", cardNum);
				frame.dispose();
			}
		});
	}
